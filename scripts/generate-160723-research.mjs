...
const RESEARCH_CONFIG_BY_CODE = {
  ...
  '168204': {
    theme: 'cn-resources',
    aliases: [
      { ticker: '515220', aliases: ['煤炭ETF'] },
      { ticker: '515280', aliases: ['煤炭ETF龙头'] },
      { ticker: '000983', aliases: ['山西焦煤'] },
      { ticker: '601898', aliases: ['中煤能源'] },
      { ticker: '601088', aliases: ['中国神华'] },
    ],
    seedHoldings: ['515220', '515280', '000983', '601898', '601088'],
    proxyComponents: [
      { ticker: '515220', weight: 0.7 },
      { ticker: '515280', weight: 0.3 },
    ],
    gapSpreadThreshold: 0.014,
    gapSignalThresholdHint: 0.01,
    fxGapWeight: 0,
    noteLabel: '煤炭板块交易时段/非交易时段',
  },
  '501036': {
    theme: 'cn-csi500',
    aliases: [
      { ticker: '510500', aliases: ['中证500ETF', '南方中证500ETF'] },
      { ticker: '159922', aliases: ['嘉实中证500ETF'] },
      { ticker: '510510', aliases: ['广发中证500ETF'] },
      { ticker: '512500', aliases: ['华夏中证500ETF'] },
      { ticker: '510300', aliases: ['沪深300ETF', '华泰柏瑞沪深300ETF'] },
    ],
    seedHoldings: ['510500', '159922', '510510', '512500', '510300'],
    proxyComponents: [
      { ticker: '510500', weight: 0.7 },
      { ticker: '159922', weight: 0.2 },
      { ticker: '510300', weight: 0.1 },
    ],
    gapSpreadThreshold: 0.012,
    gapSignalThresholdHint: 0.01,
    fxGapWeight: 0,
  ...
  '501043': {
    ...
    aliases: [
      { ticker: '510300', aliases: ['沪深300ETF', '华泰柏瑞沪深300ETF'] },
      { ticker: '159919', aliases: ['嘉实沪深300ETF'] },
      { ticker: '510310', aliases: ['沪深300ETF易方达'] },
      { ticker: '510050', aliases: ['上证50ETF'] },
      { ticker: '510500', aliases: ['中证500ETF'] },
    ],
    seedHoldings: ['510300', '159919', '510310', '510050', '510500'],
    proxyComponents: [
      { ticker: '510300', weight: 0.72 },
      { ticker: '159919', weight: 0.18 },
      { ticker: '510050', weight: 0.1 },
    ],
    gapSpreadThreshold: 0.012,
    gapSignalThresholdHint: 0.01,
    fxGapWeight: 0,
    noteLabel: '沪深300交易时段/非交易时段',
  },
  '160807': {
    theme: 'a-h-bluechip',
    aliases: [
  ...
  '161607': {
    theme: 'a-h-bluechip',
    aliases: [
      { ticker: '159901', aliases: ['深100ETF', '深证100ETF'] },
      { ticker: '159949', aliases: ['创业板50ETF'] },
      { ticker: '159915', aliases: ['创业板ETF'] },
      { ticker: '510300', aliases: ['沪深300ETF'] },
    ],
    seedHoldings: ['159901', '159949', '159915', '510300'],
    proxyComponents: [
      { ticker: '159901', weight: 0.75 },
      { ticker: '159949', weight: 0.15 },
      { ticker: '510300', weight: 0.1 },
    ],
    gapSpreadThreshold: 0.012,
    gapSignalThresholdHint: 0.01,
    fxGapWeight: 0,
    noteLabel: '深市核心宽基交易时段/非交易时段',
  },
  '161039': {
    theme: 'cn-csi500',
    aliases: [
      { ticker: '159845', aliases: ['中证1000ETF'] },
      { ticker: '512100', aliases: ['中证1000ETF基金'] },
      { ticker: '159633', aliases: ['中证1000ETF易方达'] },
      { ticker: '510500', aliases: ['中证500ETF'] },
      { ticker: '510300', aliases: ['沪深300ETF'] },
    ],
    seedHoldings: ['159845', '512100', '159633', '510500', '510300'],
    proxyComponents: [
      { ticker: '159845', weight: 0.7 },
      { ticker: '512100', weight: 0.2 },
      { ticker: '510500', weight: 0.1 },
    ],
    gapSpreadThreshold: 0.013,
    gapSignalThresholdHint: 0.01,
    fxGapWeight: 0,
    noteLabel: '中证1000交易时段/非交易时段',
  },
  '513080': {
    theme: 'france-cac40',
    aliases: [
